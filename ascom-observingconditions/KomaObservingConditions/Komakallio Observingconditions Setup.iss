...
; Generated by Jari Saukkonen on 6.3.2016 (UTC)
;
[Setup]
AppID={{b293eafd-573d-4498-9e55-928f5c63e119}
AppName=ASCOM Komakallio ObservingConditions Driver
AppVerName=ASCOM Komakallio ObservingConditions Driver 1.0
AppVersion=1.0
...
OutputDir="."
OutputBaseFilename="Komakallio ObservingConditions Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\ObservingConditions\Komakallio"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\ObservingConditions\Komakallio"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Komakallio.ObservingConditions.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Komakallio.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Komakallio.ObservingConditions.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Komakallio.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Komakallio.ObservingConditions.dll"""; Flags: runhidden 64bit; Check: IsWin64
