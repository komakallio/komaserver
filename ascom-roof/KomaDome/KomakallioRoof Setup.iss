...
; Generated by Jari Saukkonen on 6.8.2016 (UTC)
;
[Setup]
AppID={{f978cab8-037a-4ca8-a250-0b94dc3e80b8}
AppName=ASCOM KomakallioRoof Dome Driver
AppVerName=ASCOM KomakallioRoof Dome Driver 1.0
AppVersion=1.0
...
OutputDir="."
OutputBaseFilename="KomakallioRoof Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\KomakallioRoof"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\KomakallioRoof"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Komakallio.Dome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Komakallio.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Komakallio.Dome.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Komakallio.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Komakallio.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
